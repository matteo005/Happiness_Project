...
In order to answer this question following questions were asked and followed up accordingly.
    1.a How to find out the relationships? (Develope hypothesis and test)
    1.b Is there even relationship exist there? (chech test result against hypothesis)
    1.c How to tackle problem and what approach should be taken? ( Explore with data, do calculation with associated visualization to answer questions based on data. Fianlly, show the result of such a relation relation exist or not exist between GDP and Happiness index)
## Data: 
